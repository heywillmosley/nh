...
class PersonSettings
{
    ...
    public function render($meta)
    {
        ...
        <table class="form-table">
            <?php
            $leadFields = $crmFields::$fields['person'];
                ...
                if (is_array($field)) {
                    ...
                    foreach ($field as $subField) {
                        ...
                        <tr>
                            <th>
                                ...
                                <?php
                                echo in_array($subField, CrmFields::$requiredFields['person'])
                    ...
                    <tr>
                        <th>
                            ...
                            <?php
                            echo in_array($field, CrmFields::$requiredFields['person'])
                                ? '<span style="color:red;"> * </span>'
                                : '';
                            ?>
                        </th>
            ...
            $this->showCustomFields($renderFields, $currentValues, 'person');
            ?>
        </table>
        <?php
    }
