...
class OrganizationSettings
{
    ...
    {
        $renderFields = new RenderFields('organization');
        $currentValues = isset($meta['organization']) ? $meta['organization'] : [];
        $crmFields = new CrmFields();
        ?>
        <table class="form-table">
            <?php
            $leadFields = $crmFields::$fields['organization'];
                ...
                if (is_array($field)) {
                    ...
                    foreach ($field as $subField) {
                        ...
                        <tr>
                            <th>
                                ...
                                <?php
                                echo in_array($subField, CrmFields::$requiredFields['organization'])
                    ...
                    <tr>
                        <th>
                            ...
                            <?php
                            echo in_array($field, CrmFields::$requiredFields['organization'])
                                ? '<span style="color:red;"> * </span>'
                                : '';
                            ?>
                        </th>
                        <td>
                            ...
                            if ($field == 'contact_type_id') {
                                ...
                                $items = get_option(Bootstrap::CONTACT_TYPES_KEY);
            ...
            $this->showCustomFields($renderFields, $currentValues, 'company');
            ?>
        </table>
        <?php
    }
